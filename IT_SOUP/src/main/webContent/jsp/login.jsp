...
function chkFind(){
    if($("#findNM").val().length == 0){
      alert("[이름] 이름을 입력하세요.");
      $("#findNM").focus();
      return false;
    }
    
    if($("#findSSN").val().length == 0){
        alert("[주민등록번호] 주민등록번호를 입력하세요.");
        $("#findSSN").focus();
        return false;
      }
}
    ...
    %>
        <nav class="navbar navbar-default">
            <div class="navbar-header">
                <a class="navbar-brand" href="login.jsp">IT_SOUP</a>
            </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li> <a href="login.jsp?naming=<%= request.getAttribute("naming") %>?formNm=join" style="position:relative;">회원가입</a></li>
                            </ul>
                            <%
                            } else {
                            %>
        ...
        <div class="container">
            ...
            <div>
            <a href="login.jsp?formNm=main" style="position:relative; bottom:-15px; left:250px;">홈으로</a>
        </div>
        <%
        }
    } else {
            ...
            <div class="col-lg-4">
                <div class ="jumbotron" style="padding-top:20px;">
                    <form method = "post" action="loginController" onsubmit="return logincheck()">
                        ...
                        <div>
                            <a href="login.jsp?formNm=findID" style="position:relative; bottom:-15px; left:-30px;">아이디 찾기</a>
                            <a href="login.jsp?formNm=findPW" style="position:relative; 100px; bottom:-15px; left:100px;">비밀번호 찾기</a>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="col-lg-4">
                <div class ="jumbotron" style="padding-top:20px;">
                    <form method = "post" action="findController" onsubmit="return chkFind()">
                        ...
                        <div>
                            <a href="login.jsp?formNm=main" style="position:relative; bottom:-15px; left:90px;">홈으로</a>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="col-lg-4">
                <div class ="jumbotron" style="padding-top:20px;">
                    <form method = "post" action="findPwController" onsubmit="return chkFindPw()">
