        ...
        <div class="col-lg-4">
            <div class ="jumbotron" style="padding-top:20px;">
                <form method = "post" action="joinController">
                    ...
                    <div class ="form-group">
                        <input type ="text" class="form-control" placeholder="아이디 (필수입력사항)" name ="ID" maxlength='20'>
                    </div>
                    <div class ="form-group">
                        <input type ="password" class="form-control" placeholder="비밀번호 (필수입력사항)" name ="PASSWORD" maxlength='20'>
                    </div>
                    <div class ="form-group">
                        <input type ="text" class="form-control" placeholder="이름" name ="NAME" maxlength='20'>
                    </div>
                    <div class ="form-group">
                        <input type ="password" class="form-control" placeholder="주민번호 ('-' 제외)" name ="SSN" maxlength='13'>
                    </div>
                    <div class ="form-group">
                        <input type ="text" class="form-control" placeholder="핸드폰번호 ('-' 제외)" name ="HPNO" maxlength='11'>
                    </div>
                    <div class ="form-group">
